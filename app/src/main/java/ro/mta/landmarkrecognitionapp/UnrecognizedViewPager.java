...
public class UnrecognizedViewPager extends RecyclerView.Adapter<UnrecognizedViewPager.ViewHolder> {
    private ArrayList<String> imageList;
    private Context context;

    public UnrecognizedViewPager(ArrayList<String> imageList, Context context) {
