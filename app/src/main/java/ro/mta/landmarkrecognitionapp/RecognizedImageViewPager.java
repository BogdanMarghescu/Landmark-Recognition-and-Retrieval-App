...
public class RecognizedImageViewPager extends RecyclerView.Adapter<RecognizedImageViewPager.ViewHolder> {
    private List<RecognizedImages> imageList;
    private Context context;

    public RecognizedImageViewPager(List<RecognizedImages> imageList, Context context) {
