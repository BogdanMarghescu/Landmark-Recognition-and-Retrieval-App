                ...
                public void onResponse(@NonNull Call<ResponseBody> call, @NonNull Response<ResponseBody> response) {
                    ...
                    if (response.isSuccessful()) {
                        try {
                            ...
                            RecognizedImages recognizedImage = new RecognizedImages(fileToUpload.getAbsolutePath(), landmarkName, imageToUploadName, country, locality, wikiURL, latitude, longitude);
